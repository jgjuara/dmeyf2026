...
# Escribe modelo, predicciones e importancias en 02/resultados/exp4940/.

require("here")
here::i_am("juara/jueves/z494/02/2_produccion_lightgbm.R")
...
# mlrMBO puede persistir en PARAM/BO_log el espacio interno log10 (trafo 10^x).
